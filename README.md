...
> **30K records · 22 engineered features · 7 unseen clients · 0.75 Precision@20**

Built an end-to-end **content refresh ranking pipeline** on **30,000 anonymized content records**, engineering **22 search, engagement, and content features** and training Logistic Regression and Random Forest models.
...
Built **3 recommendation models** across **100,836 MovieLens ratings**, **610 users**, and **9,742 movies** using weighted popularity, TF-IDF/cosine similarity, and collaborative filtering.

**98.3%** sparse user-item space  
**35.65%** collaborative Hit Rate@10

<br>

[![View Project](https://img.shields.io/badge/View_Project-181717?style=flat-square&logo=github&logoColor=white)](https://github.com/aliakhtar1010/nextup)
...
**European Player Performance Dashboard**
...
[![View Project](https://img.shields.io/badge/View_Project-181717?style=flat-square&logo=github&logoColor=white)](https://github.com/aliakhtar1010/european-football-player-analytics)
...
**football · cricket · trying new food · probably watching a series**
